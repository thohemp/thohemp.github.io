...
summary: We present a novel method for unconstrained end-to-end head pose estimation using a continuous 6D rotation matrix representation and geodesic loss, significantly outperforming state-of-the-art methods and expanding application areas with a robust and efficient prediction of a full range of head orientations.
